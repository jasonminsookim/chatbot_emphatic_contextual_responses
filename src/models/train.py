...
# import constants
constants_dict = pickle.load(open("data/processed/constants.p", "rb"))
START_TOKEN = constants_dict['START_TOKEN']
END_TOKEN = constants_dict['END_TOKEN']
VOCAB_SIZE = constants_dict['VOCAB_SIZE']
...
# import tokenized prompts, responses, and tokenizer
tokenized_prompts = pickle.load(open("data/processed/tok_prompts.p", "rb"))
tokenized_responses = pickle.load(open("data/processed/tok_responses.p", "rb"))
tokenizer = pickle.load(open("data/processed/tokenizer.p", "rb"))
...
dataset = tf.data.Dataset.from_tensor_slices((
    {
        ...
        'dec_inputs': tokenized_responses[:, :-1]
    },
    {
        'outputs': tokenized_responses[:, 1:]
    },
))
